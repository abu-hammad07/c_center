...
<form action="{{ route('broadcast') }}">
                                ...
                                <div class="col-md-12">
                                    <div class="input-blocks">
                                        ...
                                        <select class="js-example-placeholder-multiple select2 js-states"
                                            multiple="multiple">
                                            <option value="">Type of select the recipients name
                                            </option>
                                ...
                                <div class="col-md-12">
                                    <div class="input-blocks">
                                        ...
                                        <select class="js-example-basic-single select2">
                                            <option value="" disabled selected hidden>Type or select
                                                the
                                ...
                                <div class="col-md-12">
                                    <ul class="nav nav-tabs nav-tabs-top mb-3">
                                        <li class="nav-item"><a class="nav-link active" href="#top-tab1"
                                                data-bs-toggle="tab">Text-to-speech</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#top-tab2"
                                                data-bs-toggle="tab">File upload</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="input-blocks add-product">
                                                        ...
                                                        <select class="js-example-basic-single select2">
                                                            ...
                                                            <option>English Canadian</option>
                                                            <option>English Indian</option>
                                                            <option>English Irish</option>
                                                            <option>English Welsh</option>
                                                            <option>Filipino</option>
                                                            <option>Finnish</option>
                                                            <option>French</option>
                                                            <option>French Canadian</option>
                                                            <option>French Swiss</option>
                                                            <option>German</option>
                                                            <option>German Austria</option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-blocks add-product">
                                                        <label>Voice</label>
                                                        <select class="js-example-basic-single select2">
                                                            <option>Female, Pallavi (neural)</option>
                                                            <option>Female, Shruti (beta)</option>
                                                            <option>Male, Ganesh (beta)</option>
                                                            <option>Male, Valluvar (neural)</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                        ...
                                        <div class="tab-pane" id="top-tab2">
                                            <div class="col-lg-12">
                                                <div class="drag-drop text-center mb-4">
                                                    <div class="upload">
                                                        <a href="#"><img
                                                                src="{{ URL::asset('build/img/icons/drag-drop.svg') }}"
                                                                alt=""></a>
                                                        <p>CSV <a href="#">file to upload</a></p>
                                                    </div>
                                ...
                                <div class="row mt-2 p-2">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-check-md form-switch">
                                            ...
                                            <p class="fs-15">Discover how many messages were delivered.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <h6>Data Payload</h6>
                                        <p class="fs-15">Select additional data from contacts and add it
                                            to
                                            the message. This data will be visible on message reports.
                                            Learn More</p>
                                        <div class="input-blocks">
                                            <select
                                                class="js-example-placeholder-multiple select2 js-states"
                                                multiple="multiple">
                                                ...
                                                <optgroup label="Standard Attributes">
                                                    ...
                                                    <option value="verificationServiceVerified">
                                                        Verification
                            ...
                            <div class="text-editor add-list add">
                                <div class="row mb-3">
                                    <div class="col-md-7">
                                        ...
                                        <p class="fs-15">
                                            Limit the number of messages sent out over time. Set the speed
                                            that
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-check form-check-md form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                role="switch" id="">
                                            <label class="form-check-label fw-bold" for="">Call
                                                retry</label>
                                            <p class="fs-15">Define the number of retries and the period
                                                between retries when the initial call was not answered.</p>
                                        </div>
                                    </div>
                                </div>
                                <h5>Answered call options</h5>
                                <div class="row mt-3">
                                    <div class="col-md-12 mb-3">
                                        {{--  <div class="form-check form-check-md d-flex align-items-center">
                                                <input class="form-check-input" type="checkbox" value="" id="checkebox-md"
                                                    checked="">
                                                <label class="form-check-label fw-bold" for="checkebox-md">
                                                    Medium
                                                </label>
                                            </div>  --}}
                                        <div class="form-check form-check-md form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                role="switch" id="">
                                            <label class="form-check-label fw-bold" for="">Record
                                                call</label>
                                            <p class="fs-15">Recording feature will be additionally
                                                charged.
                                                Recording might be subject to additional legal requirements
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-check-md form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                role="switch" id="">
                                            <label class="form-check-label fw-bold" for="">Detect
                                                answering
                                                machine</label>
                                            <p class="fs-15">Discover if the call went to voicemail, or a
                                                person answered it. This feature will be additionally
                                                charged.
                                                Learn more</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-check-md form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                role="switch" id="">
                                            <label class="form-check-label fw-bold" for="">Pause
                                                and call
                                                duration</label>
                                            <p class="fs-15">Define the duration of silent pause before
                                                the
                                                message starts playing and set maximum call duration.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check form-check-md form-switch">
                                            ...
                                            <label class="form-check-label fw-bold"
                                                for="">Interaction codes
                                                (DTMF)</label>
                                            <p class="fs-15">Define codes for customers to interact with
                                                your
                                                campaign using digits on their device keypad.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-lg-12">
        <div class="btn-addproduct mb-4">
            ...
            <button type="submit" class="btn btn-submit">Save Voice</button>
        </div>
    </div>
</form>
<!-- /add -->
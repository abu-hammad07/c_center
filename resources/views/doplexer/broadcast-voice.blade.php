...
@section('directry')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Voice Broadcast</li>
        </ol>
    </nav>
@endsection
                                            ...
                                            <div class="row mt-2 p-2">
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Enable delivery
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Push delivery
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Call retry</label>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Record call</label>
                                                        <p class="fs-15">Recording feature will be additionally charged.
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Detect answering
                                                            machine</label>
                                                        <p class="fs-15">Discover if the call went to voicemail, or a
                                                            person answered it. This feature will be additionally charged.
                                                            Learn more</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Pause and call
                                                            duration</label>
                                                        <p class="fs-15">Define the duration of silent pause before the
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-check form-check-md form-switch">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            id="">
                                                        <label class="form-check-label fw-bold" for="">Interaction codes
                                                            (DTMF)</label>
                                                        <p class="fs-15">Define codes for customers to interact with your

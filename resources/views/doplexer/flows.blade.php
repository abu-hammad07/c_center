        ...
        <div class="content settings-content">
            ...
            <div class="page-header settings-pg-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <a href="" class="btn  btn-square btn-secondary">Create Flow</a>
                    </li>
                    {{--  <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div
                                                            ...
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Name</span>
                                                    ...
                                                    <li>
                                                        <div
                                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Created By</span>
                                                    ...
                                                    <li>
                                                        <div
                                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Launch Date</span>
                                                    ...
                                                    <li>
                                                        <div
                                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Cost</span>
                                                    ...
                                                    <li>
                                                        <div
                                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Sent</span>
                                                            <input type="checkbox" id="option5" class="check" checked>
                                                            <label for="option5" class="checktoggle"> </label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div
                                                            class="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                            <span class="status-label"><i data-feather="menu"
                                                                    class="feather-menu"></i>Action</span>
                                                            <input type="checkbox" id="option5" class="check" checked>
                                                            <label for="option5" class="checktoggle"> </label>
                                                        </div>
                                                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-4">
                                            <div class="input-blocks">
                                                <i data-feather="search" class="info-img"></i>
                                                <select class="js-example-basic-single select2">
                                                    <option value="" disabled hidden selected>Created By</option>
                                                    <option value="hammadkamal2004">hammadkamal2004</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-3 col-4">
                                            <div class="input-blocks">
                                                <i data-feather="search" class="info-img"></i>
                                                <select class="js-example-basic-single select2">
                                                    <option value="" disabled hidden selected>Templates</option>
                                                    <option value="Build IVR flows">Build IVR flows</option>
                                                    <option value="Abandoned cart reminder">Abandoned cart reminder
                                                    </option>
                                                    <option value="Cart Abandonment - Email + SMS">Cart Abandonment - Email
                                                        + SMS</option>
                                                </select>
                                            </div>
                                        </div>
